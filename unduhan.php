...
<body>
        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="lg:w-1/6 mx-auto  ">
                ...
                <div class="flex flex-col text-center w-full mb-4 mt-10">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Download File SMPN 4 Juwana</h1>
                <div class="mb-4 mt-10">
                <input id="searchInput" type="text"  class="px-4 py-2 border min-w-full border-gray-300 rounded" placeholder="Masukan kata pencarian...">
              </div>
                  </div>
  ...
  <table id="dataTable" class="w-full h-full min-w-full bg-white border border-gray-600">
    <thead>
      <tr>
         <th class="py-2 px-4 border-b border w-1/4">No.</th>
        <th class="py-2 px-4 border-b border w-1/4">Nama</th>
        <th class="py-2 px-4 border-b border w-1/4">File</th>
        <th class="py-2 px-4 border-b border w-1/4">Ukuran</th>
        <th class="py-2 px-4 border-b border w-1/4">Aksi</th>
      </tr>
    </thead>
    <tbody id="dataRows">
      <tr>
        <td class="py-2 px-4 border-b">1</td>
        <td class="py-2 px-4 border-b">Surat Pengumuman Kelulusan</td>        
        <td class="py-2 px-4 border-b">Surat-Pengumuma.pdf</td>
        <td class="py-2 px-4 border-b">12982 Kb</td>
        <td class="py-2 px-4 border-b">
            <button class="py-2 px-4 border hover:bg-blue-700 hover:text-white border-gray-300 rounded">Download</button>
        </td>
      </tr>
      
      <tr>
        <td class="py-2 px-4 border-b">2</td>
        <td class="py-2 px-4 border-b">Surat Pemberitahuan Libur Nasional</td>
        <td class="py-2 px-4 border-b">Surat-Pemberitahuan-libur-2024.pdf</td>
        <td class="py-2 px-4 border-b">12983 Kb</td>
        <td class="py-2 px-4 border-b">
            <button class="py-2 px-4 border hover:bg-blue-700 hover:text-white border-gray-300 rounded">Download</button>
        </td>

      </tr>
                    <p id="dataNotFound" class="text-center text-gray-500 mt-10 mb-10 hidden">File Yang Anda Cari Tidak Ditemukan!</p>
...
<script>
  ...
  const tableRows = dataRows.getElementsByTagName('tr');
