...
<html lang="en">
  <head>
    ...
    <title>Admin SMP N 4 Juwana | Login</title>
            ...
            <div class="card-body p-0">
              ...
              <div class="row">
                <div class="col-lg-6 d-none d-lg-block">
                  <img src="assets/images/bg.jpg" alt="" width="500px" height="400px" class="justify-content-center relative  bg-no-repeat bg-cover bg-center mx-auto">
                </div>
                <div class="col-lg-6">
                  <div class="p-5">
